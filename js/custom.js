var domain = 'http://localhost/live_xsSquared';
...
function renderOrderBook(exchange, currencypair){
    ...
    chart = AmCharts.makeChart("chartdiv", {
        ...
        "dataLoader": {
            ...
            "url": domain+"/cloud/api/beta/order"+whichExchange+".php?currencypair="+currencypair,
            "format": "json",
            "reload": 30,
...
function renderCandleChart(exchange, currencypair, period){
    $.getJSON(domain+'/cloud/api/beta/'+exchange+'.php?currencypair='+currencypair+"&period="+period, function (data) {
        console.log(data);
        hideLoading();
...
function userAuth(){
    ...
    $.ajax({
        url:domain+domain+'/cloud/api/beta/getUserInfo.php'+oauthString,
...
function register(){
    ...
    $.ajax({
        url:domain+'/cloud/api/beta/register.php'+oauthString,
        data:{
...
function login(){
    ...
    $.ajax({
        url:domain+'/cloud/api/beta/login.php',
        data:{
...
function logout(){
    $.ajax({
        url:domain+'/cloud/api/beta/logout.php',
        complete:function(transport){
...
function cancelOrder(orderId){
    ...
    $.ajax({
        url:domain+'/cloud/api/beta/cancelMockOrder.php?oauth='+localStorage.getItem('oauth')+'&orderId='+orderId,
        complete:function(transport){
...
function placeMockOrder(symbol, price, amount, type){
    ...
    $.ajax({
        url:domain+'/cloud/api/beta/createMockOrder.php',
        data:theOrderData,
