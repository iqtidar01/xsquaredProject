...
curl_setopt_array($curl, array(
    ...
    CURLOPT_URL => 'https://api.bithumb.com/public/orderbook/'.$currencypair,
...
$respArr = array();
$respArr['timestamp'] = $resp['data']['timestamp'];
$respArr['bids'] = array();
foreach ($resp['data']['bids'] as $item){
  $respArr['bids'][] = array_values((array)$item);
}
$respArr['asks'] = array();
foreach ($resp['data']['asks'] as $item){
  $respArr['asks'][] = array_values((array)$item);
}
